        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-700 font-raleway">
                <li>
                  <a href="mailto:info@sunbrilotechnologies.com" className="flex items-center gap-2 hover:text-black transition-colors">
                    <svg className="w-4 h-4 text-black shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
                      <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/>
                    </svg>
                    info@sunbrilotechnologies.com
                  </a>
                </li>
                <li>
                  <a href="tel:+918788563349" className="flex items-center gap-2 hover:text-black transition-colors">
                    <svg className="w-4 h-4 text-black shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <li>
                  <a href="https://maps.google.com/?q=I-Space+IT+Park,+Ground+Floor,+Pranjali+Patil+Nagar,+Next+to+Seigal+Maruti+Showroom+Bavdhan,+Pune,+MH+Pincode-+411021" target="_blank" rel="noopener noreferrer" className="flex items-start gap-2 hover:text-black transition-colors">
