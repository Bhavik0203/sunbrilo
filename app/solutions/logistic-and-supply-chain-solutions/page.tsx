  ...
  const features = [
    {
      ...
      image: "/images/solutions/106.jpg"
    },
    {
      step: '02',
      ...
      image: "/images/solutions/105.jpg"
    },
    {
      step: '03',
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 ref={textRef} className="text-4xl md:text-5xl font-bold leading-tight mb-6 font-raleway">
                  {renderAnimatedText("Eliminate Blind Spots. Accelerate Global Delivery.", scrollProgress)}
                </h2>
...
<FAQSection category="Logistic and Supply Chain" />
