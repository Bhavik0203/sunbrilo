      ...
      <div className="min-h-screen">
        ...
        <section className="relative min-h-[520px] py-24 px-4 text-white flex items-center justify-center">
          <div
            ...
            style={{ backgroundImage: 'url("/images/solutions/Logistics & Supply Chain.jpeg")' }}
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 ref={textRef} className="text-4xl md:text-5xl font-bold leading-tight mb-6 font-raleway">
                  {renderAnimatedText("From Fragmentation to Full Fulfillment Accountability", scrollProgress)} </h2>
...
<FAQSection category="Order Management" />
