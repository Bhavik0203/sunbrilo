...
export default function DevelopmentTestingPage() {
  ...
  return (
    <>
      <Head>
        <title> Hyper-Accelerated Enterprise System Implementation & Rollout | Sunbrilo</title>
        <meta name="description" content=" Achieve guaranteed business continuity during your digital transformation rollout. We specialize in complex system integration, zero-downtime legacy system migration, and global software deployment." />
        <meta name="keywords" content="Enterprise IT project implementation services, Complex system integration, Global software deployment, Legacy system migration, Digital transformation rollout." />
      </Head>
      ...
      <div className="min-h-screen">
        ...
        <section className="relative min-h-[500px] py-20 px-4 text-white flex items-center justify-center">
          ...
          <div
            ...
            style={{
              backgroundImage: 'url("/images/services/Implementation services.jpg")',
            }}
          >
            {/* Dark Overlay */}
          ...
          <div className="relative z-10 max-w-6xl mx-auto">
            <div className="text-center">
              <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6 font-raleway">
                Risk-Managed Enterprise Rollout for Hyper-Accelerated Time-to-Value.
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  ...
                  <span className="relative z-10 flex items-center gap-2 transition-colors duration-500 group-hover:text-[#FFEE50]">
                    Initiate a Zero-Risk Deployment Assessment
              ...
              Explore Our Deployment Architecture Services
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-8 font-raleway">
                  From Vision to Velocity:<br />Overcoming the Deployment Gap
                </h2>
                <p className="text-base leading-relaxed text-gray-600 mb-6 font-raleway">
                  Enterprise deployment is the single greatest point of failure in digital transformation. Traditional rollouts suffer from scope creep, integration incompatibility, and cascading data corruption risks, leading to millions in lost opportunity cost and crippling project delays.
                </p>
                <p className="text-base leading-relaxed text-gray-600 mb-6 font-raleway">
                  Sunbrilo specializes in de-risking this critical phase. We treat implementation as a strategic asset, leveraging deep experience in complex system integration to seamlessly deploy your core platforms-from multi-cloud ERPs to proprietary industrial applications-across your international footprint. Our focus is not just deployment, but guaranteed performance under peak operational load.
                </p>
              </div>
              ...
              <div className="relative h-[380px] lg:h-[420px]">
                ...
                >
                  <img
                    src="/images/services/image 63.png"
                ...
                >
                  <img
                    src="/images/services/image 64.png"
...
<FAQSection category="Implementation Services" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                ...
                <div className="relative overflow-hidden ">
                  <img
                    src="/images/services/image 70.png"
                ...
                <div className="absolute -bottom-8 -left-8 w-40 h-40 rounded-full overflow-hidden  border-white">
                  <img
                    src="/images/services/image 71.png"
