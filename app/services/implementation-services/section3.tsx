...
import { caseStudies } from "../../lib/case-studies5";
...
export default function CaseStudiesPage() {
  return (
    <div className="min-h-screen bg-[#f5f3f3] px-4 py-12 md:px-8 md:py-16">
      ...
      The Pillars of Enterprise Deployment Excellence
        </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto font-raleway">
       Our implementation service pillars are designed to manage complexity and ensure absolute operational readiness.
           </p>
            </div>
