...
import { caseStudies } from "../../lib/case-studies3";
  ...
  return (
    <div className="min-h-screen bg-[#f5f3f3] px-4 py-12 md:px-8 md:py-16">
      <main className="mx-auto max-w-7xl">
        ...
        Strategic Pillars of Cloud Transformation
         </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto font-raleway">
          From initial readiness assessments to ongoing 24/7 management, we handle the complete lifecycle of your cloud ecosystem.
            </p>
            </div>
