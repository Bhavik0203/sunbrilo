...
import { caseStudies } from "../../lib/case-studies4";
...
export default function CaseStudiesPage() {
  return (
    <div className="min-h-screen bg-[#f5f3f3] px-4 py-12 md:px-8 md:py-16">
      ...
      Full-Stack Security Orchestration & Compliance Assurance
         </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto font-raleway">
          We deliver a complete security lifecycle, focused on threat detection, rapid incident response, and continuous audit readiness.
           </p>
            </div>
