...
import { caseStudies } from "../../lib/case-studies6";
  ...
  return (
    <div className="min-h-screen bg-[#f5f3f3] px-4 py-12 md:px-8 md:py-16">
      <main className="mx-auto max-w-7xl">
       ...
       Predictable Performance. Guaranteed Resolutions.  </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto font-raleway">
        We provide a multi-layered, strategic operational shield for your mission-critical infrastructure.    </p>
            </div>
