  ...
  const qualityItems = [
    {
      ...
      tagline: "Legally Enforceable Metrics",
      content: "We deploy rigorous, legally enforceable SLAs with penalty clauses tailored to your required metrics, ensuring near-instantaneous response times (often sub-10 minutes) for Priority 1 (P1) business-critical events.",
      Icon: Terminal,
    },
    {
      index: "02",
      title: "Automated Incident Management",
      tagline: "Seamless ITSM Integration",
      content: "Seamless, bidirectional integration with all major ITSM platforms (ServiceNow, PagerDuty, Jira Service Desk). Every incident lifecycle is fully tracked, managed, and auditable, creating a transparent security and operational record.",
      Icon: ShieldCheck,
    },
    {
      index: "03",
      title: "Structural Root Cause Analysis",
      tagline: "Permanent Flaw Resolution",
      content: "We eliminate recurrence. After every high-severity event, our L3 architects conduct mandatory, comprehensive post-mortems to identify the fundamental flaw, deploying permanent architecture or code fixes to prevent the issue from ever reoccurring.",
      Icon: Layers,
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col">
            ...
            <p className="text-gray-600 max-w-xl mb-12 text-base leading-relaxed font-medium">
              True cloud transformation goes beyond servers; it enables business agility and security.
            </p>
