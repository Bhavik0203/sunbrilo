            ...
            return (
              ...
              <article
                ...
                className={`relative mx-auto max-w-6xl bg-white px-6 py-10 md:px-12 md:py-14 overflow-hidden ${
                  isRight
                    ? "rounded-l-[32px] rounded-r-full bg-[radial-gradient(circle_at_85%_50%,#5BA3E85C,transparent_55%),linear-gradient(to_left,_#5BA3E840_0%,_#5BA3E81F_26%,_#5BA3E80D_48%,_#f0f7ff_64%,_#ffffff_78%,_#ffffff_100%)]"
                    : "rounded-r-[32px] rounded-l-full bg-[radial-gradient(circle_at_15%_50%,#5BA3E85C,transparent_55%),linear-gradient(to_right,_#5BA3E840_0%,_#5BA3E81F_26%,_#5BA3E80D_48%,_#f0f7ff_64%,_#ffffff_78%,_#ffffff_100%)]"
                }`}
              >
