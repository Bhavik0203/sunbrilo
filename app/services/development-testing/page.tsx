...
export default function DevelopmentTestingPage() {
  ...
  return (
    <>
      <Head>
        <title>Custom Enterprise Software Development & QA Testing | Sunbrilo</title>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-8 font-raleway">
                  Built for Scale.<br />Tested for Perfection.
                </h2>
                <p className="text-base leading-relaxed text-gray-600 mb-6 font-raleway">
                  Launching software with critical bugs or poor architectural foundations can cost an enterprise millions in lost revenue, security breaches, and diminished brand trust. As a leading B2B software development agency in India, Sunbrilo eliminates technical debt before it happens.
                </p>
                <p className="text-base leading-relaxed text-gray-600 font-raleway">
                  We do not believe in fragmented development cycles. Whether you are building a secure corporate portal, a high-volume SaaS platform, or a proprietary internal tool, our dedicated engineering pods integrate development and quality assurance from day one. The result is secure, lightning-fast software that performs flawlessly under immense operational pressure.
                </p>
              </div>
