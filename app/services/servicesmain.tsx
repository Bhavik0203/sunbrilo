...
const capabilities = [
  {
    ...
    desc: 'Custom, bug-free applications engineered for your exact operational bottlenecks. From complex backend logistics to intuitive frontend UX, we build software that drives revenue.',
    link: 'Explore Software Development',
    image: '/images/services/service1.png',
  },
  {
    title: 'Offshore IT Staff Augmentation',
    label: ['OFFSHORE IT', 'STAFF AUGMENTATION'],
    desc: 'Scale your engineering capacity overnight. Hire a dedicated offshore development team that seamlessly adopts your culture, tools, and time zones without the local overhead.',
  ...
  },
  {
    ...
    desc: 'Break free from legacy limitations. We execute zero-downtime migrations and provide ongoing enterprise cloud managed services across AWS, Azure, and GCP.',
  ...
  },
  {
    ...
    desc: 'Turn raw global data into a competitive weapon. We build sophisticated data pipelines and AI-driven dashboards for real-time business intelligence.',
    link: 'Unlock Data Analytics',
    image: '/images/services/service4.png',
  },
  {
    title: 'Managed IT & Cybersecurity',
    label: ['MANAGED IT', '& CYBERSECURITY'],
    desc: 'Protect your infrastructure from evolving global threats. We provide 24/7 proactive monitoring, vulnerability management, and rapid incident response.',
